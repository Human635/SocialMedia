    ...
    <ContainerMainPage>
      ...
      <div className="MainPage">
        ...
        <main className="Main">
          ...
          {data?.message?.length && 
            data?.message?.map((post: any) => <Post  key={post.id} postText={post.main_text} postDate={post.reg_date} photos={post.photos} userName={post.user_fk.name} postId={post.id}/>)
          }
